...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>Laravel Webshop Example</title>
        ...
        <div id="app">
            <header class="with-background">
                ...
                <div class="hero container">
                    <div class="hero-copy">
                        <h1>Laravel Webshop Demo</h1>
                        <p>Includes multiple products, categories, a shopping cart and a checkout system with Stripe integration.</p>
                        <div class="hero-buttons">
                           
                            <a href="https://github.com/ShiroWorks/Laravel-Device-Seller" class="button button-white">GitHub</a>
                        </div>
                    </div> <!-- end hero-copy -->

                    <div class="hero-image">
                        <img src="img/webshop-logo.jpg" alt="hero image">
                    </div> <!-- end hero-image -->
                </div> <!-- end hero -->
            </header>
            ...
            <div class="featured-section">
                ...
                <div class="container">
                    <h1 class="text-center">Laravel Webshop</h1>
